...
template<class T> void BinaryTree<T>::insertRic(T value, Nodo<T> *prec, Nodo<T> *curr)
{
    if(getRoot() == nullptr)
        root = new Nodo<T>(value);
    else if(curr == nullptr)
        insertNode(value, prec, curr);
...
template<class T> void BinaryTree<T>::insertNode(T value, Nodo<T> *prec, Nodo<T> *curr)
{
